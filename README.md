...
* Leprosy association analysis: contains scripts and example genotype, phenotype and covariate data to perform association analysis and meta-analysis. Association analysis was performed using SNPTEST v2.5.1: [Marchini J, *et al*. "A new multipoint method
